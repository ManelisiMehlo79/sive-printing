...
export default function DecryptedText({
  ...
  animateOn = 'hover',
  clickMode = 'once',
  /** When `animateOn` is `"view"`, run decrypt whenever the element re-enters the viewport after leaving */
  repeatOnView = false,
  ...props
}) {
  ...
  useEffect(() => {
    ...
    const observerCallback = entries => {
      entries.forEach(entry => {
        if (repeatOnView && animateOn === 'view' && !entry.isIntersecting) {
          clearInterval(intervalRef.current);
        ...
        if (repeatOnView && animateOn === 'view') {
          clearInterval(intervalRef.current);
          triggerDecrypt();
          return;
        }
  ...
  }, [animateOn, hasAnimated, triggerDecrypt, repeatOnView, resetToPlainText]);
